                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href= "{{url('/table-reservation')}}">Reservation</a></li>       
                    ...
                    <div class="left-content">
                        <div class="inner-content">
                            ...
                            <div class="main-white-button scroll-to-section">
                                <a href="{{url('/table-reservation')}}">Make A Reservation</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>Klassy Cafe is one of the best restaurant in your area. You can get 100% fresh and halal foods over here .Price are very reasonable. You can book our resturent for your special day. Contact us for pre booking. <br><br>You are NOT allowed to take outside food and pets.Contact us for more information.</p>
                        <div class="row">
                            <div class="col-4">
